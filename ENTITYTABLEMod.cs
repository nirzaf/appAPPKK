...
namespace appMODEL
{
    ...
    public class ENTITYTABLE
    {
        ...
        public string CurrentChildNo { get; set; }
        public string ParenterProgName { get; set; }
        public string ToperProgName { get; set; }
        ...
        public List<ENTITYTABLEType> ENTITYTABLETypes { get; set; }   //for inner dropdown list within grid column

        public long Document_ID { get; set; }    //for Upload of a Document
        public string Risk_Level { get; set; }
        public long Risk_Level_ID { get; set; }
        public List<ENTITYTABLERiskLevelList> RiskTypess { get; set; }
    ...
    {
        public long ENTITYTABLE_Type_ID { get; set; }
        public string ENTITYTABLETypeName { get; set; }
    }
    ...
    /// </summary>
    public class ENTITYTABLERiskLevelList
    {
